...
const WHATSAPP_URL = "https://wa.me/918291218234?text=I%20have%20a%20question%20about%20my%20child%27s%20future";
      ...
      <section className="py-20 md:py-28 bg-card">
        <div className="container px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto text-center">
            <p className="font-body text-muted-foreground text-lg mb-4">Every parent worries about their child</p>
            ...
            <p className="font-body text-lg text-muted-foreground mb-10">Your child&apos;s Kundli reveals their natural strengths, best timing, and destined path.</p>
            <WhatsAppButton />
          </motion.div>
        </div>
      </section>
